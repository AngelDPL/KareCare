...
const Budgets = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.items.length === 0) {
            setError("Añade al menos un item al presupuesto")
            return
        }
        try {
            await post("/budgets", {
            ...
            setError(err.error || "Error al crear presupuesto")
        }
    }
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-gray-500 text-sm mt-1">{budgets.length} presupuestos registrados</p>
                    </div>
                    <button
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="border border-gray-200 rounded-xl p-4">
                                <h3 className="text-sm font-semibold text-gray-700 mb-3">Añadir tratamiento</h3>
                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th className="text-left px-6 py-3 text-gray-500 font-medium">Válido hasta</th>
                                        ...
                                        {expanded === b.id && (
                                            <tr key={`items-${b.id}`}>
                                                <td colSpan="6" className="px-6 py-3 bg-gray-50">
                                                    ...
                                                    {b.notes && (
                                                        <p className="text-xs text-gray-500 mt-2">Notas: {b.notes}</p>
                                                    )}
                                                </td>
                                            </tr>
                                        )}
