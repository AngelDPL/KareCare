"""init: modelos iniciales

Revision ID: fc5d4b7303b7
Revises: 
Create Date: 2026-04-23 13:48:38.524248
...
def upgrade():
    ...
    sa.Column('business_RIF', sa.String(length=15), nullable=False),
    sa.Column('business_CP', sa.String(length=10), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('business_RIF')
    )
    ...
    sa.Column('client_dni', sa.String(length=20), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('client_dni'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.CheckConstraint('payments_made <= estimated_total', name='check_payments_valid'),
    sa.ForeignKeyConstraint(['client_id'], ['clients.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
