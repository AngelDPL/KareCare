...
import type { Payment, PaymentMethods, PaymentStatus, Client } from "../types"
...
const Payments = () => {
    ...
    const handleDeletePayment = async (id: number) => {
        if (!confirm("¿Remove this entire payment?")) return
        try {
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setForm({ ...form, payment_method: e.target.value as PaymentMethods })}
                                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400"
                                >
                                            ...
                                            <tr key={`abono-${p.id}`}>
                                                <td colSpan={7} className="px-6 py-4 bg-indigo-50">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <select
                                                            value={abonoMethod}
                                                            onChange={(e) => setAbonoMethod(e.target.value as PaymentMethods)}
                                                            className="border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400"
                                                        >
                                                            <option value="cash">Efectivo</option>
                                                            <option value="card">Tarjeta</option>
